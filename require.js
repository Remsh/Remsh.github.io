        ...
        return E = {
            ...
            init: function (e, t, i, r) {
                ...
                if (this.enabled && !this.enabling) {
                    var e, t, i = this.map.id, r = this.depExports, exports = this.exports, n = this.factory;
                    if (this.inited) {
                        if (this.error)this.emit("error", this.error); else if (!this.defining) {
                            if (this.defining = !0, this.depCount < 1 && !this.defined) {
                                if (isFunction(n)) {
                                    if (this.events.error && this.map.isDefine || req.onError !== defaultOnError)try {
                                        exports = q.execCb(i, n, r, exports)
                                    } catch (a) {
                                        e = a
                                    } else exports = q.execCb(i, n, r, exports);
                                    if (this.map.isDefine && void 0 === exports && (t = this.module, t ? exports = t.exports : this.usingExports && (exports = this.exports)), e)return e.requireMap = this.map, e.requireModules = this.map.isDefine ? [this.map.id] : null, e.requireType = this.map.isDefine ? "define" : "require", u(this.error = e)
                                } else exports = n;
                                this.exports = exports, this.map.isDefine && !this.ignore && (j[i] = exports, req.onResourceLoad && req.onResourceLoad(q, this.map, this.depMaps)), d(i), this.defined = !0
                            }
            ...
            execCb: function (e, t, i, exports) {
                return t.apply(exports, i)
            },
